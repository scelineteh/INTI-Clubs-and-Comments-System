...
<body>
<p class="badminton"></p>
<p class ="header">Badminton Club</p>
<p style="font-size: 20px"> The table below shows the members that are in Badminton Club.</p>
<style type="text/css">
table{
...
$query = 'SELECT fullname,email, phone_number, studentid FROM vote WHERE club ="badminton" ';
...
$query = 'SELECT fullname,comment FROM comment WHERE club ="badminton" ';
